...
<body>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  class="active-menu" href="index5.jsp"><i class="fa fa-bar-chart"></i> Tipe Indikasi 5</a>
                    </li>
                    <li>
            ...
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="page-header">
                            <div id="qm-info"><h1>Tipe Indikasi 5 <small><i class="fa fa-question-circle"></i></small></h1></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12" id="info-row">
                        <div class="info">
                            Tipe indikasi 5 berdasarkan indikasi tidak diterimanya sanggahan; menggunakan data periode waktu sanggahan. <br />
                            <small>Periode masa sanggah yang singkat dapat mengindikasikan tidak diharapkannya sanggahan dari peserta lelang yang kalah untuk menganulir kemenangan peserta yang telah ditentukan, mengindikasikan kurangnya transparansi dan keterbukaan panitia lelang terhadap peserta.</small>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default" data-num="0">
                            <div class="row header-chart">
                                <div class="col-md-12">
                                    <div class="col-md-5">
                                        <h2>Grafik Periode Masa Sanggah Lelang</h2>
                                    </div>
                                    <div class="col-md-7">
                                        <div class="row">
                                            <div class="col-md-4">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            Plotly.d3.json('http://localhost/jing/getJSONT5.php', function(rows) {
                ...
                var allLPSE = unpack(rows, 'lpse').reverse(),
                        ...
                        allVal = unpack(rows, 'periodemasasanggah').reverse(),
