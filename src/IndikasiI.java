...
public class IndikasiI {
    ...
    public static String[][] getAllSatker() throws IOException {
        ...
        try {
            ...
            */
            ...
            stringsatker = new String[1][4];
            String query = "SELECT distinct lpse, agency, satker from lelang where satker = \"Dinas Bina Marga Provinsi Jawa Barat\"";
            ResultSet result = statement.executeQuery(query);
            int i = 0;
            while (result.next()) {
                //Retrieve by column name
    ...
    public static void dbTulisIndikasiI(String[] unitstring) throws IOException {
        ...
        try {
            ...
            preparedStatement = connect.prepareStatement("insert into  indikasi1 values (?, ?, ?, ?, ?, ?, ?, ?, ?)");
