    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var layout1 = {
                ...
                title: 'Tipe Indikasi 1 - Periode Lelang',
                showlegend: false
            };
            ...
            d3.json("json/new/v1_t1periode.json", function(d) {
                console.log(d);
                for (var i = 0; i < d.length; i++) {
                    arrgraphx1.push(d[i].id);
                    arrgraphy1.push(d[i].periodelelang);
                }
            ...
            d3.json("json/new/v1_t1meanselisih.json", function(d) {
                console.log(d);
                for (var i = 0; i < d.length; i++) {
                    arrgraphx2.push(d[i].id);
                    arrgraphy2.push(d[i].meanselisihtahap);
                }
