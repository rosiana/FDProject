...
<body>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="index4.jsp"><i class="fa fa-bar-chart"></i> Tipe Indikasi 4</a>
                    </li>
                    <li>
            ...
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="page-header">
                            <div id="qm-info"><h1>Tipe Indikasi 4 <small><i class="fa fa-question-circle"></i></small></h1></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12" id="info-row">
                        <div class="info">
                            Tipe indikasi 4 berdasarkan indikasi penundaan surat penetapan; menggunakan data periode waktu penetapan pemenang.  <br />
                            <small>Kemungkinan dilakukannya penundaan surat penetapan oleh pegawai ULP atau pihak terkait untuk menunggu <i>facilitating payment</i> (uang pelicin) dapat diamati dari periode penetapan pemenang yang lama.</small>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default" data-num="0">
                            <div class="row header-chart">
                                <div class="col-md-12">
                                    <div class="col-md-5">
                                        <h2>Grafik Periode Penetapan Pemenang</h2>
                                    </div>
                                    <div class="col-md-7">
                                        <div class="row">
                                            <div class="col-md-4">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            Plotly.d3.json('http://localhost/jing/getJSONT4.php', function(rows) {
                ...
                var allLPSE = unpack(rows, 'lpse').reverse(),
                        ...
                        allVal = unpack(rows, 'periodepenetapanpemenang').reverse(),
