...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.getJSON("json/t5.json", function (data) {

                for (var i = 0; i < data.length; i++) {

                    dataPoints1.push({ label: data[i].id, y: data[i].periodemasasanggah, namalelang: data[i].namalelang, agency: data[i].agency, pagu: data[i].pagu, hps: data[i].hps, penawaranmenang: data[i].penawaranmenang, namapemenang: data[i].namapemenang, status: data[i].status, keterangan: data[i].keterangan });
